...
#[derive(Debug)]
pub struct NeuralFlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeuralFlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeuralFlow processing");
    
    let mut processor = NeuralFlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeuralFlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeuralFlowProcessor::new(false);
